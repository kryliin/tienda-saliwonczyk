    ...
    <Container>
      ...
      <div className='cartconteiner'>
        <div className='cartIzquierda'>
          {cartList.map(producto => <div className='cartItem' key={producto.id} > {producto.foto} {producto.nombre} - Cantidad: {producto.cantidad}  ${producto.precio * producto.cantidad}</div>)}
        </div>
