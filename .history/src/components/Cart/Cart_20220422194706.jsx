    ...
    <Container>
      ...
      <div className='cartconteiner'>
        <div className='cartIzquierda'>
          {cartList.map(producto => <div className='cartItem' key={producto.id} >  <img src={producto.foto} alt=''/> <div className='cartDetalle' >{producto.nombre} <br/> Cantidad: {producto.cantidad}  ${producto.precio * producto.cantidad}</div></div>)}
        </div>
