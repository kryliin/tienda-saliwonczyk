    ...
    <Container>
      ...
      <div className='cartconteiner'>
        <div className='cartIzquierda'>
          {cartList.map(producto => <div className='cartItem' key={producto.id} >  <img src={producto.foto} alt='' /> <div className='cartDetalle' > <p>{producto.nombre}</p>  <p>Cantidad: {producto.cantidad}  ${producto.precio * producto.cantidad}</p></div></div>)}
        </div>
