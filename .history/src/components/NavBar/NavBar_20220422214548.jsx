                    ...
                    <Navbar.Collapse id="responsive-navbar-nav">
                        <Nav className="me-auto">
                            ...
                            <NavDropdown title="Juegos" id="collasible-nav-dropdown">
                                ...
                                <NavLink to="/detalle/:detalleId" element={<ItemDetailedConteiner categoriaId='Familiar'/>}>
                                ...
                                <NavLink to="/detalle/:detalleId" element={<ItemDetailedConteiner categoriaId='Estrategia'/>}>
