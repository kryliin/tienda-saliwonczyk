                    ...
                    <Navbar.Collapse id="responsive-navbar-nav">
                        <Nav className="me-auto">
                            ...
                            <NavDropdown title="Juegos" id="collasible-nav-dropdown">
                                ...
                                <NavLink to="/detalle/Familiar" element={<ItemDetailedConteiner categoriaId='Familiar'/>}>
                                    <NavDropdown.Item >Familiar</NavDropdown.Item>
                                </NavLink>
                                <NavLink to="/detalle/:detalleId" element={<ItemDetailedConteiner categoriaId='Accion'/>}>
                                    <NavDropdown.Item >Accion</NavDropdown.Item>
                                </NavLink >
                                <NavLink to="/detalle/Estrategia" element={<ItemDetailedConteiner categoriaId='Estrategia'/>}>
                                    <NavDropdown.Item>Estrategia</NavDropdown.Item>
                                </NavLink>
                                <NavLink to="/detalle/:detalleId" element={<ItemDetailedConteiner categoriaId='Preguntas y Respuestas'/>}>
                                    <NavDropdown.Item >Preguntas y Respuestas</NavDropdown.Item>
                                </NavLink>
                                <NavLink to="/detalle/:detalleId" element={<ItemDetailedConteiner categoriaId='Infantiles'/>}>
